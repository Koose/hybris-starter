...
<%@ taglib prefix="fn" uri="http://java.sun.com/jsp/jstl/functions" %>
	...
	<div class="headline"><spring:theme code="guest.checkout" arguments="${fn:escapeXml(siteName)}"/></div>
		...
		<form:form action="${action}" method="post" commandName="guestForm">
			...
			<div class="form-group">
				<label class="col-form-label" for="guest.confirm.email"> <spring:theme code="guest.confirm.email" /></label>
				<input class="confirmGuestEmail form-control" id="guest.confirm.email"/>
			</div>

			<ycommerce:testId code="guest_Checkout_button">
				<div class="form-group">
					<button type="submit" disabled="true" class="btn btn-secondary btn-block guestCheckoutBtn"><spring:theme code="${actionNameKey}"/></button>
				</div>
			</ycommerce:testId>
