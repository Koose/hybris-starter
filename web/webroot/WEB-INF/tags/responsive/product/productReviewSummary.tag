...
<div class="rating">
	<div class="rating-stars float-left js-ratingCalc ${starsClass}" data-rating='{"rating":"${product.averageRating}","total":5}' >
		<div class="greyStars">
	...
	<c:choose>
		<c:when test="${showLinks}" >
			...
			<a href="#myTab" class="js-writeReviewTab"><spring:theme code="review.write.title" /></a>
		</c:when>
		<c:otherwise>
