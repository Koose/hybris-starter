...
<div class="tab-review">
	<div class="review-pagination-bar">
		<button class="btn btn-secondary js-review-write-toggle "><spring:theme code="review.write.title"/></button>

		<div class="right">
			<button class="btn btn-secondary all-reviews-btn"><spring:theme code="review.show.all" /></button>
			<button class="btn btn-secondary less-reviews-btn"><spring:theme code="review.show.less" /></button>
		</div>
	</div>
				...
				<div class="rating rating-set js-ratingCalcSet">
					<div class="rating-stars js-writeReviewStars">
                        <c:forEach  begin="1" end="10" varStatus="loop">
                            <span class="js-ratingIcon icon-star ${loop.index % 2 == 0 ? 'lh' : 'fh'}"></span>
                        </c:forEach>
