...
<header class="js-mainHeader">
	<nav class="navigation navigation--top  hidden-md-down">
		<div class="row">
	...
	<div class="hidden-md-down js-secondaryNavAccount collapse" id="accNavComponentDesktopOne">
		<ul class="nav__links">

		</ul>
	</div>
	<div class="hidden-md-down js-secondaryNavCompany collapse" id="accNavComponentDesktopTwo">
	...
	<nav class="navigation navigation--middle js-navigation--middle">
		<div class="container-fluid">
				...
				<div class="mobile__nav__row mobile__nav__row--table">
					<div class="mobile__nav__row--table-group">
						<div class="mobile__nav__row--table-row">
							<div class="mobile__nav__row--table-cell hidden-sm-up">
								<button class="mobile__nav__row--btn btn mobile__nav__row--btn-menu js-toggle-sm-navigation"
										type="button">
									<span class="icon-menu glyphicon-align-justify"></span>
								</button>
							</div>

							<div class="mobile__nav__row--table-cell hidden-sm-up mobile__nav__row--seperator">
								<ycommerce:testId code="header_search_activation_button">
									<button	class="mobile__nav__row--btn btn mobile__nav__row--btn-search js-toggle-xs-search hidden-sm-up" type="button">
							...
							<cms:pageSlot position="MiniCart" var="cart" element="div" class="miniCartSlot componentContainer mobile__nav__row--table hidden-sm-up">
			...
			<div class="row desktop__nav">
				<div class="nav__left col-12 col-sm-6">
					<div class="row">
						<div class="col-sm-2 hidden-xs-down visible-sm-up hidden-lg-up mobile-menu">
				...
				<div class="nav__right col-6 hidden-xs-down">
					<ul class="nav__links nav__links--shop_info">
						<li>
							<c:if test="${empty hideHeaderLinks}">
								<ycommerce:testId code="header_StoreFinder_link">
									<div class="nav-location hidden-xs-down">
