    ...
    <div class="pagination-bar ${(top)?"top":"bottom"}">
        <div class="pagination-toolbar">
            <c:if test="${not empty searchPageData.sorts}">
                <div class="helper clearfix hidden-md-up"></div>
                <div class="sort-refine-bar">
                    <div class="row">
                        <div class="col-12 col-sm-12 col-md-4 pagination-sort-container">
                            <div class="form-group">
                                <label class="col-form-label pagination-sort-label" for="sortForm${top ? '1' : '2'}">
                        ...
                        <c:if test="${not hideRefBtn}">
                            <div class="col-12 col-sm-6 col-md-4 hidden-lg-up align-self-end pagination-refine-container">
                                <ycommerce:testId code="searchResults_refine_button">
                                    <product:productRefineButton styleClass="btn btn-secondary js-show-facets"/>
                                </ycommerce:testId>
                            </div>
                        </c:if>

                        <div class="col-12 col-sm-6 col-md-4 pagination-wrap">
