        ...
        <c:if test="${hasPreviousPage}">
            <li class="page-item pagination-prev">
                ...
                <ycommerce:testId code="searchResults_previousPage_link">
                    <a href="${previousPageUrl}" rel="prev" class="page-link icon-angle-left"></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasPreviousPage}">
            <li class="page-item pagination-prev disabled"><span class="icon-angle-left page-link"></span></li>
        </c:if>
        ...
        <c:if test="${hasNextPage}">
            <li class="pagination-next">
                ...
                <ycommerce:testId code="searchResults_nextPage_link">
                    <a href="${nextPageUrl}" rel="next" class="page-link icon-angle-right"></a>
                </ycommerce:testId>
            </li>
        </c:if>

        <c:if test="${!hasNextPage}">
            <li class="page-item pagination-next disabled"><span class="page-link icon-angle-right"></span></li>
        </c:if>
    </ul>
</c:if>