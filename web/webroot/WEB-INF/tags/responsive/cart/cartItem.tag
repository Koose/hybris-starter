...
<c:if test="${not empty entry}">
        ...
        <li class="item__list--item">
            ...
            <div class="item__price">
                <span class="d-md-none"><spring:theme code="basket.page.itemPrice"/>: </span>
                <format:price priceData="${entry.basePrice}" displayFreeForZero="true"/>
            </div>

            <%-- quantity --%>
            <div class="item__quantity d-none d-md-table-cell">
                <c:choose>
                    <c:when test="${not entry.product.multidimensional}" >
                        ...
                        <form:form id="updateCartForm${entryNumber}" action="${cartUpdateFormAction}" method="post" commandName="updateQuantityForm${entry.entryNumber}"
                            ...
                            <ycommerce:testId code="cart_product_quantity">
                                <form:label cssClass="d-md-none" path="quantity" for="quantity${entry.entryNumber}"></form:label>
                    ...
                    <c:otherwise>
                        ...
                        <form:form id="updateCartForm${entryNumber}" action="${cartUpdateMultiDFormAction}" method="post" class="js-qty-form${entryNumber}" commandName="updateQuantityForm${entryNumber}">
                            ...
                            <input type="hidden" name="productCode" value="${fn:escapeXml(entry.product.code)}"/>
                            <input type="hidden" name="initialQuantity" value="${entry.quantity}"/>
                            <label class="d-md-none"><spring:theme code="basket.page.qty"/>:</label>
            ...
            <ycommerce:testId code="cart_totalProductPrice_label">
                <div class="item__total js-item-total d-none d-md-table-cell">
            ...
            <div class="item__menu">
                <c:if test="${entry.updateable}" >
                    <div class="btn-group js-cartItemDetailGroup">
                        <button type="button" class="btn js-cartItemDetailBtn" aria-haspopup="true" aria-expanded="false" id="editEntry_${entryNumber}">
            ...
            <div class="item__quantity__total d-md-none">
                <c:if test="${entry.product.multidimensional}" >
                    <ycommerce:testId code="cart_product_updateQuantity">
