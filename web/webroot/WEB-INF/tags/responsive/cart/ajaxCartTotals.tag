...
<script id="cartTotalsTemplate" type="text/x-jquery-tmpl">
    <div class="row">
        <div class="col-6cart-totals-left"><spring:theme code="basket.page.totals.subtotal"/></div>
        <div class="col-6cart-totals-right text-right">
             <ycommerce:testId code="Order_Totals_Subtotal">{{= subTotal.formattedValue}}</ycommerce:testId>
        </div>


        {{if deliveryCost}}
            <div class="col-6cart-totals-left"><spring:theme code="basket.page.totals.delivery"/></div>
            <div class="col-6cart-totals-right text-right">
        ...
        {{if net && totalTax.value > 0}}
            <div class="col-6cart-totals-left"><spring:theme code="basket.page.totals.netTax"/></div>
            <div class="col-6cart-totals-right text-right">{{= totalTax.formattedValue}}</div>
        {{/if}}
		...
		{{if quoteDiscounts.value > 0}}
			<div class="col-6cart-totals-left discount">
				<spring:theme code="basket.page.quote.discounts"/>
			</div>
			<div class="col-6cart-totals-right text-right discount">
        ...
        <div class="col-6cart-totals-left grand-total"><spring:theme code="basket.page.totals.total"/></div>
        <div class="col-6cart-totals-right text-right grand-total">
