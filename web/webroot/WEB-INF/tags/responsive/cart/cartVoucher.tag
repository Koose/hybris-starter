...
<div class="form-group js-voucher-respond ${containerClass}">
    ...
    <label class="col-form-label cart-voucher__label" for="voucher-code"><spring:theme
            code="text.voucher.apply.input.label"/></label>
    <form:form id="applyVoucherForm" action="${applyVoucherAction}" method="post" commandName="voucherForm" class="form-inline">
        <form:input cssClass="js-voucher-code cart-voucher__input form-control" name="voucher-code"
		...
		<c:if test="${not disableUpdate}">
	        <button type="button" id="js-voucher-apply-btn" class="btn btn-primary cart-voucher__btn">
        ...
        <li class="voucher-list__item">
            <form:form id="removeVoucherForm${loop.index}" action="${removeVoucherAction}" method="post"
                ...
                <span class="js-release-voucher voucher-list__item-box" id="voucher-code-${fn:escapeXml(voucher)}">
                    ...
                    <span class="icon-remove js-release-voucher-remove-btn voucher-list__item-remove"></span>
                </span>
            </form:form>
        </li>
    </c:forEach>
