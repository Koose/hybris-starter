...
<div class="js-cart-totals row">
    <div class="col-6 cart-totals-left"><spring:theme code="basket.page.totals.subtotal"/></div>
    ...
    <c:if test="${not empty cartData.deliveryCost}">
        <div class="col-6 cart-totals-left"><spring:theme code="basket.page.totals.delivery"/></div>
    ...
    <c:if test="${cartData.net && cartData.totalTax.value > 0 && showTax}">
        <div class="col-6 cart-totals-left"><spring:theme code="basket.page.totals.netTax"/></div>
	...
	<c:if test="${cartData.quoteDiscounts.value > 0}">
		<div class="col-6 cart-totals-left discount">
    ...
    <div class="col-6 cart-totals-left grand-total"><spring:theme code="basket.page.totals.total"/></div>
