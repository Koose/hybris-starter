            ...
            <div class="col-12 col-xl-8">
                <div class="store__finder--pagination">
                    <div class="float-right">
                        <button class="btn btn-secondary js-store-finder-pager-prev" type="button">
                            <spring:theme code="storeFinder.pagination.previous" text="Previous"></spring:theme>
                        </button>
                        <button class="btn btn-secondary js-store-finder-pager-next" type="button">
                ...
                <div class="store__finder--panel row">
                    <div class="store__finder--navigation">
                        <ul class="store__finder--navigation-list js-store-finder-navigation-list">
                            <li class="loading"><span class="icon-update"></span></li>
                        </ul>
                    </div>

                    <div class="store__finder--details js-store-finder-details">
                        <div>
                            <button class="btn btn-secondary store__finder--details-back js-store-finder-details-back">
