					...
					<form:form action="${storeFinderFormAction}" method="get" commandName="storeFinderForm">
						...
						<ycommerce:testId code="storeFinder_search_box">
							<div class="input-group">
								<spring:theme code="pickup.search.message" var="placeHolderMessage" />
								<formElement:formInputBoxInline idKey="storelocator-query" labelKey="storelocator.query" path="q" labelCSS="sr-only" inputCSS="form-control js-store-finder-search-input" mandatory="true"  placeholder="pickup.search.message" />
