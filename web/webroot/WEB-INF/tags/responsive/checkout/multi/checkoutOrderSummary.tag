...
<div class="checkout-summary-headline d-none d-md-block">
...
<div class="d-none d-md-visible clearfix">
    <form:form action="${placeOrderUrl}" id="placeOrderForm1" commandName="placeOrderForm" class="place-order-form col-12">
        <div class="form-check">
            <form:checkbox id="Terms1" path="termsCheck" class="form-check-input" />
