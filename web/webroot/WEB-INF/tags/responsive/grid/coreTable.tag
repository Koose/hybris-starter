...
<tr>
    ...
    <c:forEach items="${variants}" var="variant">
        ...
        <td class="${cssStockClass} widthReference d-none d-md-table-cell">

            <div class="variant-prop d-md-none" data-variant-prop="${fn:escapeXml(variant.variantValueCategory.name)}">
    ...
    <td class="variant-select d-md-none">
