	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h5 class="modal-title"><spring:theme code="checkout.summary.scheduleReplenishment"/></h5>
			...
			<div class="modal-body">
				...
				<div class="column scheduleform scheduleformW" style="display: none;">
					...
					<div class="div_nWeeks2">
						...
						<div class="row scheduleform-checkboxes">
							<form:checkboxes id="daysOfWeek" items="${daysOfWeek}" itemLabel="name" itemValue="code" path="nDaysOfWeek" element="div class='scheduleform-checkbox col-md-4 col-6'" />
						</div>
					</div>
				</div>
				...
				<div class="js-replenishment-actions">
					<div class="modal-actions">
						...
						<button type="button" class="btn btn-block btn-secondary" id="cancelReplenishmentOrder">
