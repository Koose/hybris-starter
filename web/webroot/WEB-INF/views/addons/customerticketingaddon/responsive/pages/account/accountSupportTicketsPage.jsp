            ...
            <tbody>
                <c:forEach items="${searchPageData.results}" var="supportTicket">
                    ...
                    <tr class="responsive-table-item">
                        <td class="hidden-md-up"><spring:theme code="text.account.supporttickets.ticketId" text="Ticket ID" /></td>
                        <td><a href="${myAccountsupportTicketDetailsUrl}" class="responsive-table-link"><c:out value="${supportTicket.id}" /></a></td>
                        
                        <td class="hidden-md-up"><spring:theme code="text.account.supporttickets.subject" text="Subject" /></td>
                        ...
                        <td class="hidden-md-up"><spring:theme code="text.account.supporttickets.dateCreated" text="Date Created" /></td>
                        <td><fmt:formatDate value="${supportTicket.creationDate}" pattern="dd-MM-yy hh:mm a" /></td>
                        
                        <td class="hidden-md-up"><spring:theme code="text.account.supporttickets.dateUpdated" text="Date Updated" /></td>
                        <td><fmt:formatDate value="${supportTicket.lastModificationDate}" pattern="dd-MM-yy hh:mm a" /></td>
                        
                        <td class="hidden-md-up"><spring:theme code="text.account.supporttickets.status" text="Status" /></td>
