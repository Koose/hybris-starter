...
<template:page pageTitle="${pageTitle}">
    <div class="account-section container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-sm-3 col-sm-push-2">
                        ...
                        <div class="account-cards card-select">
                            <div class="row">
                                <c:forEach items="${searchPageData.results}" var="user">
                                    ...
                                    <div id="row-${ycommerce:normalizedCode(user.normalizedUid)}" class="col-12 col-sm-6 col-md-4 card <c:if test='${user.selected}'>selected</c:if>">
                                        <ul class="pull-left">
                                            <li>
                                        ...
                                        <ycommerce:testId code="${action}_actions_label">
                                            ...
                                            <c:choose>
                                                <c:when test="${user.active}">
                                                    <span id="selection-${ycommerce:normalizedCode(user.normalizedUid)}" class="account-cards-actions float-left">
                                                        <c:choose>
        ...
        <div class="accountActions-bottom hidden-md-up">
            <org-common:done url="${cancelUrl}" labelKey="text.company.done.button"/>
        </div>
