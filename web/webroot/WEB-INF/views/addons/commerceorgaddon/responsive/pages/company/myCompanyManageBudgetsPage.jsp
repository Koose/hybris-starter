...
<template:page pageTitle="${pageTitle}">
    <div class="account-section container-fluid">
			...
			<div class="account-section-content">
                ...
                <div class="account-overview-table">
                    <table class="table responsive-table">
                        <tr class="responsive-table-head hidden-sm-down">
                        ...
                        <c:forEach items="${searchPageData.results}" var="b2bBudget">
                            ...
                            <tr class="responsive-table-item">
                                <td class="hidden-md-up"><spring:theme code="text.company.column.id.name"/></td>
                                ...
                                <td class="hidden-md-up"><spring:theme code="text.company.column.name.name"/></td>
                                <td class="responsive-table-cell">
                                    <ycommerce:testId code="budget_name_link">
                                        ${fn:escapeXml(b2bBudget.name)}
                                    </ycommerce:testId>
                                </td>
                                <td class="hidden-md-up"><spring:theme code="text.company.column.parentUnit.name"/></td>
                                <td class="responsive-table-cell">
                                ...
                                <td class="hidden-md-up"><spring:theme code="text.company.manage.units.costCenters"/></td>
                                <td class="responsive-table-cell">
                                    <ycommerce:testId code="budget_unit_label">
                                ...
                                <td class="hidden-md-up"><spring:theme code="text.company.budget.amount"/></td>
                                <td class="responsive-table-cell">
                                ...
                                <td class="hidden-md-up"><spring:theme code="text.company.budget.start"/></td>
                                <td class="responsive-table-cell">
                                    <ycommerce:testId code="budget_startDate_label">
                                        <fmt:formatDate value="${b2bBudget.startDate}" />
                                    </ycommerce:testId>
                                </td>
                                <td class="hidden-md-up"><spring:theme code="text.company.budget.end"/></td>
                                <td class="responsive-table-cell">
                                    <ycommerce:testId code="budget_endDate_label">
                                        <fmt:formatDate value="${b2bBudget.endDate}" />
                                    </ycommerce:testId>
                                </td>
                                <td class="hidden-md-up"><spring:theme code="text.company.column.status.name"/></td>
                                <td class="responsive-table-cell">
