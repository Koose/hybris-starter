...
<template:page pageTitle="${pageTitle}">
    <div class="account-section container-fluid">
        <div class="account-section-header">
            ...
            <div class="account-section-header-add float-right">
            ...
            <div class="account-section-content">
                ...
                <div class="account-overview-table">
                    <table class="table responsive-table">
                        <tr class="account-orderhistory-table-head responsive-table-head hidden-sm-down">
                            <th>
                        ...
                        <c:forEach items="${searchPageData.results}" var="result">
                            ...
                            <tr class="responsive-table-item">
                                ...
                                <td class="hidden-md-up"><spring:theme code="text.company.column.type"/></td>
                                <td class="responsive-table-cell">
                                ...
                                <td class="hidden-md-up"><spring:theme code="text.company.${action}.timespan.label"/></td>
                                <td class="responsive-table-cell">
                                    <company:permissionTimespan permission="${result}"/>
                                </td>
                                <td class="hidden-md-up"><spring:theme code="text.company.${action}.value.title"/></td>
                                <td class="responsive-table-cell">
