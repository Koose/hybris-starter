                        ...
                        <table class="table responsive-table">
                            ...
                            <c:forEach items="${searchPageData.results}" var="user">
                                ...
                                <tr class="responsive-table-item">
                                    ...
                                    <td class="hidden-md-up"><spring:theme code="text.company.column.roles.name"/></td>
                                    <td class="responsive-table-cell">
                                    ...
                                    <td class="hidden-md-up"><spring:theme code="text.company.manageUser.user.costCenter"/></td>
                                    <td class="responsive-table-cell">
                                    ...
                                    <td class="hidden-md-up"><spring:theme code="text.company.status.title"/></td>
                                    <td class="responsive-table-cell">
