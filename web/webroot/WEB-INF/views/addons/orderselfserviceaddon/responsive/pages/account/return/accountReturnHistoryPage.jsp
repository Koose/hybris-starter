	...
	<div class="account-section-content	">
		<div class="account-orderhistory account-returnorder">
			...
			<div class="account-overview-table">
				<table class="table orderhistory-list-table returnorder-list-table responsive-table">
					<tr class="account-orderhistory-table-head account-returnorder-table-head responsive-table-head hidden-sm-down">
					...
					<c:forEach items="${searchPageData.results}" var="myReturn">
						<tr class="responsive-table-item">
							<ycommerce:testId code="orderHistoryItem_orderDetails_link">
								<td class="hidden-md-up"><spring:theme code="text.account.returnHistory.rma" /></td>
								<td class="responsive-table-cell">
									<a href="${returnDetailsUrl}${fn:escapeXml(myReturn.code)}" class="responsive-table-link">
											${fn:escapeXml(myReturn.rma)}
									</a>
								</td>
								<td class="hidden-md-up"><spring:theme code="text.account.returnHistory.orderNumber" /></td>
								<td class="responsive-table-cell">
								...
								<td class="hidden-md-up"><spring:theme code="text.account.returnHistory.returnStatus"/></td>
								<td class="status">
