	...
	<div class="account-section-content	">
		<div class="account-orderhistory">
			...
			<div class="responsive-table">
				<table id="order_history" class="table responsive-table">
					<thead>
					...
					<c:forEach items="${searchPageData.results}" var="order">
						<tr class="responsive-table-item">
							<td class="hidden-md-up"><spring:theme code='text.account.orderApprovalDashBoard.orderNumber'/></td>
							...
							<td class="hidden-md-up"><spring:theme code='text.account.orderApprovalDashBoard.purchaseOrderNumber'/></td>
							<td class="responsive-table-cell">
							...
							<td class="hidden-md-up"><spring:theme code='text.account.orderApprovalDashBoard.orderStatus'/></td>
							<td class="status">
							...
							<td class="hidden-md-up"><spring:theme code="text.account.orderApprovalDetails.orderPlacedBy" /></td>
							<td class="responsive-table-cell">
								<ycommerce:testId code="orderApprovalDashboard_orderpurchaser_link">
									${fn:escapeXml(order.b2bOrderData.b2bCustomerData.name)}
								</ycommerce:testId>
							</td>
							<td class="hidden-md-up"><spring:theme code='text.account.orderHistory.datePlaced'/></td>
							<td class="responsive-table-cell">
								<fmt:formatDate value="${order.b2bOrderData.created}" dateStyle="medium" timeStyle="short" type="both" />
							</td>
							<td class="hidden-md-up responsive-table-cell-bold"><spring:theme code='text.account.order.total'/></td>
