		...
		<c:if test="${empty quickViewShowAddToCart ? true : quickViewShowAddToCart}">
				...
				<div class="qty-selector input-group js-qty-selector">
					<span class="input-group-btn">
						<button class="btn btn-primary js-qty-selector-minus" type="button" <c:if test="${qtyMinus <= 1}"><c:out value="disabled='disabled'"/></c:if> ><span class="icon-minus" aria-hidden="true"></span></button>
					</span>
