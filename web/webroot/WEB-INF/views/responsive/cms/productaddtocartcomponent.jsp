...
<div class="addtocart-component">
		...
		<div class="qty-selector input-group js-qty-selector">
			<span class="input-group-btn">
				<button class="btn btn-secondary js-qty-selector-minus" type="button" <c:if test="${qtyMinus <= 1}"><c:out value="disabled='disabled'"/></c:if> ><span class="glyphicon glyphicon-minus" aria-hidden="true" ></span></button>
			</span>
			...
			<span class="input-group-btn">
				<button class="btn btn-secondary js-qty-selector-plus" type="button"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></button>
			</span>
		</div>
		</c:if>
        ...
        <c:if test="${multiDimensionalProduct}" >
                ...
                <a href="${productOrderFormUrl}" class="btn btn-secondary btn-block btn-icon js-add-to-cart glyphicon-list-alt">
