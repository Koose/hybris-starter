...
<div class="container-fluid">
    <div class="footer__top">
        <div class="row">
            <div class="footer__left col-12 col-sm-12 col-md-9">
                <div class="row">
                    <c:forEach items="${navigationNodes}" var="node">
                        <c:if test="${node.visible}">
                            <c:forEach items="${node.links}" step="${component.wrapAfter}"
                                ...
                                <div class="footer__nav--container col-12 col-sm-3">
            ...
            <div class="footer__right col-12 col-md-3">
                <c:if test="${showLanguageCurrency}">
                    <div class="row">
                        <div class="col-6 col-md-6 footer__dropdown">
