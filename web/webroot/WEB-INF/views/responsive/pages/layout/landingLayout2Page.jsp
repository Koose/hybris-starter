...
<template:page pageTitle="${pageTitle}">
    ...
    <div class="row no-margin">
        <div class="col-12 col-md-6 no-space">
            <cms:pageSlot position="Section2A" var="feature" element="div" class="row no-margin">
                <cms:component component="${feature}" element="div" class="col-12 col-sm-6 no-space yComponentWrapper"/>
            </cms:pageSlot>
        </div>
        <div class="col-12 col-md-6 no-space">
    ...
    <cms:pageSlot position="Section4" var="feature" element="div" class="row no-margin">
        <cms:component component="${feature}" element="div" class="col-6 col-md-3 no-space yComponentWrapper"/>
    </cms:pageSlot>
