		...
		<multiCheckout:checkoutSteps checkoutSteps="${checkoutSteps}" progressBarId="${progressBarId}">
			<jsp:body>
								...
								<form:form id="silentOrderPostForm" name="silentOrderPostForm" commandName="sopPaymentDetailsForm" action="${paymentFormUrl}" method="POST">
									...
									<div class="form-group">
										<c:if test="${not empty paymentInfos}">
											<button type="button" class="btn btn-secondary btn-block js-saved-payments"><spring:theme code="checkout.multi.paymentMethod.addPaymentDetails.useSavedCard"/></button>
										</c:if>
									</div>
									...
									<fieldset id="startDate">
										<label for="" class="col-form-label"><spring:theme code="payment.startDate"/></label>
										<div class="row">
											<div class="col-6">
									...
									<fieldset id="cardDate">
										<label for="" class="col-form-label"><spring:theme code="payment.expiryDate"/></label>
										<div class="row">
											<div class="col-6">
				...
				<c:if test="${not empty paymentInfos}">
					...
					<div class="modal fade" id="savedpayments" tabindex="-1" role="dialog"aria-hidden="true">
