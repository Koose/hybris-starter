	...
	<c:if test="${not empty addressData}">
		<div class="account-cards card-select">
			...
			<c:forEach items="${addressData}" var="address">
				...
				<div id="popup_confirm_address_removal_${fn:escapeXml(address.id)}" class="modal fade"  tabindex="-1" role="dialog"  aria-hidden="true">
						...
						<div class="modal-content">
							...
							<div class="modal-footer">
								<div class="row">
									...
									<div class="col-12 col-sm-6">
										<a class="btn btn-outline-primary btn-block" data-dismiss="modal" data-address-id="${fn:escapeXml(address.id)}">
