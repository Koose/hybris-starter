            ...
            <div class="account-cards card-select">
                <div class="row">
                	<c:forEach items="${paymentInfoData}" var="paymentInfo">
                        <div class="col-12 col-sm-6 col-md-4 card-box">
                            <div class="card">
                                <ul class="float-left">
                                    <li>
                        ...
                        <div class="modal fade" id="popup_confirm_payment_removal_${fn:escapeXml(paymentInfo.id)}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered" role="document">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title" >
                                            <spring:theme code="text.account.paymentDetails.delete.popup.title"/>
                                        </h5>
                                        ...
                                        <div class="row">
                                            <ycommerce:testId code="paymentDetailsDelete_delete_button" >
                                                <div class="col-12 col-sm-6 col-sm-push-6">
                                                    <button type="submit" class="btn btn-primary btn-primary btn-block paymentsDeleteBtn">
                                                        <spring:theme code="text.account.paymentDetails.delete"/>
                                                    </button>
                                                </div>
                                            </ycommerce:testId>
                                            <div class="col-12 col-sm-6 col-sm-pull-6">
                                                <a data-dismiss="modal" class="btn btn-outline-primary btn-block" data-payment-id="${fn:escapeXml(paymentInfo.id)}">
