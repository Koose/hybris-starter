            ...
            <table class="table responsive-table">
                ...
                <c:forEach items="${searchPageData.results}" var="savedCart" varStatus="loop">
                    ...
                    <tr id="row-${loop.index}" class="responsive-table-item"> 		
						...
						<td class="responsive-table-cell">
							<div class="js-saved-cart-date ${importCartIsProcessing ? 'hide' : '' }">
						...
						<td class="responsive-table-cell">
						 ...
						 <td class="responsive-table-cell restore-item-column text-center">
							<ycommerce:testId code="savedCarts_restore_link">
								<a href="#" class="js-restore-saved-cart restore-item-link ${importCartIsProcessing || fn:length(savedCart.entries) < 1 ? 'hide' : '' }"
									...
									<span class="d-none d-md-inline"><spring:theme code='text.account.savedCart.restore'/></span>
									<span class="icon-edit d-md-none"></span>
								</a>
							</ycommerce:testId>
						</td>
						<td class="responsive-table-cell remove-item-column">
							<ycommerce:testId code="savedCarts_delete_link">
								<a href="#" class="js-delete-saved-cart remove-item-link ${importCartIsProcessing ? 'hide' : '' }"
									data-savedcart-id="${fn:escapeXml(savedCart.code)}"
						...
						<div class="modal fade" id="modal-restore-cart-${fn:escapeXml(savedCart.code)}" tabindex="-1" role="dialog"  aria-hidden="true">
						</div>
                    </tr>
                </c:forEach>
            </table>
