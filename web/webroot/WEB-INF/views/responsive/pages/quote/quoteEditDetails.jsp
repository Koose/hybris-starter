...
<form:form method="post" commandName="quoteForm" id="quoteForm" action="#">
    ...
    <div class="form__actions container-fluid">
        <div class="row">
            ...
            <c:if test="${allowedActions['CANCEL']}">
                <div class="col-sm-4 col-md-3 offset-md-3">
                    <button type="button" class="btn btn-secondary btn-block js-quote-cancel-btn form__actions--cancel">
                ...
                <div class="col-sm-4 col-md-3 mt-4 mt-md-0">
                    <c:choose>
                        <c:when test="${cartData.totalPrice.value lt 0}">
                            <button type="button" class="btn btn-primary btn-block pull-right js-quote-submit-btn form__actions--submit" disabled="disabled" >
                                <spring:theme code="quote.submit" />
                            </button>
                        </c:when>
                        <c:otherwise>
                            <button type="button" class="btn btn-primary btn-block pull-right js-quote-submit-btn form__actions--submit">
                                <spring:theme code="quote.submit" />
                            </button>
                        </c:otherwise>
                    </c:choose>
        ...
        <div class="quote__head">
            <div class="row">
                ...
                <div class="col-2 text-right d-md-none">
                    <button class="quote__form--toggle js-quote-toggle-btn collapsed" type="button" data-toggle="collapse" data-target="#quote__form--collapse" aria-expanded="false" aria-controls="quote__form--collapse"></button>
                </div>
