...
<c:if test="${not empty cartData.rootGroups}">
    ...
    <div class="row justify-content-between">
        <div class="col-12 cart-actions--print">
            <div class="cart__actions border">
                <div class="row">
                    ...
                    <c:if test="${not empty siteQuoteEnabled and siteQuoteEnabled eq 'true'}">
                        <div class="col-sm-4 col-md-3 offset-md-3 pull-right order-sm-11">
                            <button class="btn btn-secondary btn-block btn-create-quote js-create-quote-button" data-create-quote-url="${createQuoteUrl}">
