...
<div class="row justify-content-end">
    <div class="col-12 col-sm-10 col-md-7 col-lg-6 cart-actions--print">
    ...
    <div class="row justify-content-between">
        ...
        <sec:authorize access="!hasAnyRole('ROLE_ANONYMOUS')">
            <c:if test="${not empty siteQuoteEnabled and siteQuoteEnabled eq 'true'}">
                <div class="col-sm-4 col-md-3 offset-md-3 order-sm-11">
                    <button class="btn btn-secondary btn-block btn--continue-shopping js-continue-shopping-button"    data-continue-shopping-url="${createQuoteUrl}">
        ...
        <div class="col-sm-4 col-md-3">
            <button class="btn btn-secondary btn-block btn--continue-shopping js-continue-shopping-button" data-continue-shopping-url="${continueShoppingUrl}">
